...
interface DoctorMobileMenuProps {
  isOpen: boolean;
  onClose: () => void;
...
const DoctorMobileMenu: React.FC<DoctorMobileMenuProps> = ({
  isOpen,
  onClose,
  showNotifications,
//   activeLink,
          ...
          <>
            ...
            <div className={styles.menuHeader}>
              <div className={styles.menuProfile}>
                <div className={styles.avatar} aria-hidden="true">TO</div>
                <div className={styles.menuProfileText}>
                  <p className={styles.menuProfileName}>Dr. Tobenna Obi</p>
                  <p className={styles.menuProfileRole}>Doctor</p>
                </div>
              </div>
