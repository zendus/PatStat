...
// const PatientMobileHeader: React.FC<PatientMobileHeaderProps> = ({ onMenuToggle, onNotificationToggle }) => {
//   return (
//     <header className={styles.mobileHeader}>
//       <div className={styles.mobileLogo}>
//         <Image
//           src="/images/pat-stat-patient-menu-logo.svg"
//           alt="Pat-Stat logo"
//           width={100}
//           height={33}
//           priority
//         />
//         <span className={styles.mobileRole}>Family</span>
//       </div>
//       <div className={styles.mobileActions}>
//         <button className={styles.mobileActionBtn} onClick={onNotificationToggle} aria-label="Notifications">
//           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//             <path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
//             <path d="M13.73 21a2 2 0 01-3.46 0"></path>
//           </svg>
//           <span className={styles.notificationBadge}>0 New</span>
//         </button>
//         <button className={styles.mobileActionBtn} onClick={onMenuToggle} aria-label="Open menu">
//           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
