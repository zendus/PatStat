...
interface NurseMobileMenuProps {
  isOpen: boolean;
  onClose: () => void;
...
const NurseMobileMenu: React.FC<NurseMobileMenuProps> = ({
  isOpen,
  onClose,
  showNotifications,
//   activeLink,
          ...
          <>
            ...
            <div className={styles.menuHeader}>
              <div className={styles.menuProfile}>
                <div className={styles.avatar} aria-hidden="true">CO</div>
                <div className={styles.menuProfileText}>
                  <p className={styles.menuProfileName}>Chisom Okeke</p>
                  <p className={styles.menuProfileRole}>Nurse</p>
                </div>
              </div>
