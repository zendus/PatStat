      ...
      <div className={styles.card}>
        <div className={styles.left}>
          ...
          <div className={styles.leftContent}>
            ...
            <div className={styles.hero}>
              <h1 className={styles.heroTitle}>Stay Informed About Your Loved One&apos;s Care</h1>
              <p className={styles.heroSubtitle}>
                Pat-Stat provides secure, real-time updates directly from the hospital care team.
              </p>
        ...
        <div className={styles.right}>
          <div className={styles.stepBadge} aria-label="Step 2 of 2: Account Creation">
            ...
            <span className={styles.stepName}>Account Creation</span>
          </div>

          <div className={styles.formWrap}>
            <h2 className={styles.formTitle}>Create Your Secure Access</h2>
            <p className={styles.formSubtitle}>Set up your login to securely view patient updates.</p>
