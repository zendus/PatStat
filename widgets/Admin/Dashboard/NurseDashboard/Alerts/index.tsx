...
<path d="M16.0423 27.5007L25.209 34.3757L36.6673 18.334M27.5007 50.4173C40.1575 50.4173 50.4173 40.1575 50.4173 27.5007C50.4173 14.8438 40.1575 4.58398 27.5007 4.58398C14.8438 4.58398 4.58398 14.8438 4.58398 27.5007C4.58398 40.1575 14.8438 50.4173 27.5007 50.4173Z" stroke="#00D492" stroke-width="4.58333"/>
</svg>
...
const NoEmergencyCases: React.FC = () => (
  <div className={styles.noEmergencyContainer}>
    <CheckCircleIcon />
    <h3 className={styles.noEmergencyTitle}>No Active Alerts</h3>
...
const NurseAlertPage: React.FC = () => {
  // Use a state to simulate emergency cases being active or not
  const [hasEmergencies, setHasEmergencies] = useState(false); // Set to true initially for the active state
