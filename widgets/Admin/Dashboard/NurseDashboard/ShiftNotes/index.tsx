  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.header}>
        <h1>Shift Notes</h1>
        <p className={styles.subtitle}>Document shift observations</p>
      </div>

      {/* Create Handover Summary card */}
      <div className={styles.summaryCard}>
        <h2 className={styles.cardTitle}>Add Shift Note</h2>
        <textarea
          className={styles.textarea}
          placeholder="General shift observations, patient notes, handover information..."
          value={handoverNote}
