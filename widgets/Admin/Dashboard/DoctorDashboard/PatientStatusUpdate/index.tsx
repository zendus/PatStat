...
const PatientStatusUpdatePage: React.FC = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.header}>
        <h1>Patient Status Update</h1>
        <p className={styles.subtitle}>Quick access to update patient conditions</p>
      </div>
...
export { PatientStatusUpdatePage };