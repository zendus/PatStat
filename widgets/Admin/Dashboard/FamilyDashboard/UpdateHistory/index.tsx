...
const LatestHistory: React.FC = () => {
  return (
    <div className={styles.latestUpdateWrapper}>
      <h1 className={styles.contentTitle}>Update History</h1>
      <p className={styles.contentSubtitle}>Complete history of patient status</p>
