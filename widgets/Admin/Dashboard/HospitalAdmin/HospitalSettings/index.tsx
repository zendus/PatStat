...
// <path d="M6.13672 22.5082V4.09301C6.13672 3.55034 6.35229 3.0299 6.73602 2.64617C7.11974 2.26245 7.64018 2.04688 8.18285 2.04688H16.3674C16.91 2.04688 17.4305 2.26245 17.8142 2.64617C18.1979 3.0299 18.4135 3.55034 18.4135 4.09301V22.5082H6.13672Z" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// <path d="M6.13914 12.2773H4.09301C3.55034 12.2773 3.0299 12.4929 2.64617 12.8766C2.26245 13.2604 2.04688 13.7808 2.04688 14.3235V20.4619C2.04688 21.0045 2.26245 21.525 2.64617 21.9087C3.0299 22.2924 3.55034 22.508 4.09301 22.508H6.13914" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// <path d="M18.4141 9.20801H20.4602C21.0029 9.20801 21.5233 9.42358 21.907 9.80731C22.2908 10.191 22.5063 10.7115 22.5063 11.2541V20.4617C22.5063 21.0044 22.2908 21.5248 21.907 21.9086C21.5233 22.2923 21.0029 22.5079 20.4602 22.5079H18.4141" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// <path d="M10.2266 6.13867H14.3188" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// <path d="M10.2266 10.2305H14.3188" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// <path d="M10.2266 14.3232H14.3188" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// <path d="M10.2266 18.415H14.3188" stroke="#62748E" stroke-width="2.04613" stroke-linecap="round" stroke-linejoin="round"/>
// </svg>
...
//   const [hospitalType, setHospitalType] = useState("Specialist");
//   const [timeZone, setTimeZone] = useState("West Africa Time (WAT)");
...
//         </div>
//         <button className={styles.editInformationBtn} type="button">
...
//               defaultValue="Parklane General Hospital"
//             //   readOnly
//             />
//           </div>
//           <div className={styles.formGroup}>
...
//               // Keep disabled if editing is not enabled
//             >
...
//               id="contactEmail"
//               className={styles.formInput}
//               defaultValue="admin@hospital.ng"
//             //   readOnly
//             />
//           </div>
//           <div className={styles.formGroup}>
...
const HospitalSettingsPage: React.FC = () => {
  ...
  const handleEdit = () => {
    setDraftData({ ...formData }); // snapshot current saved values into draft
    setIsEditing(true);
  };

  const handleSave = () => {
    setFormData({ ...draftData }); // commit draft to saved state
    setIsEditing(false);
  };

  const handleCancel = () => {
    setDraftData({ ...formData }); // discard draft, restore saved values
    setIsEditing(false);
  };
